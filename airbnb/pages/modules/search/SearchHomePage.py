...
def submit_search_hotels_form(city_name, from_date, to_date, adults_count, children_count, infants_count):
    ...
    if search_form.select_guests(adults_count, children_count):
        pass
    else:
